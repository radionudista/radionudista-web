              ...
              <div key={`show_${index}`} className="glass-card mb-8" >
                <div className="flex sm:flex-row flex-col mb-[0.5rem]">
                  <div className="show-name flex-[1_1_0] sm:mb-[0] mb-[1rem]">
                    ...
                    <p className="text-white">{lang == 'es' ? show.description : show.descriptionPt}</p>
                  </div>
                  <div className="show-time flex-[1_1_0] flex flex-col items-center justify-center sm:mb-[0] mb-[1rem] text-white">
                    {lang == 'es' ? <p>conducido por:</p> : <p>apresentado por:</p>}
                    <p className='mb-3'>{
                        show.talent.map((t,i)=>{
                    ...
                    <p className="mb-8">{
                        show.social?.map((t,i)=>{
                            ...
                            return show.social.length == i+1 ? <span key={`talent_${i}`}>{t} </span> : <><span key={`talent_${i}`}>{t}</span><span> - </span></>
                        })
                    }</p>
